...
const NavBar = () => {
   ...
   {user ?  <li onClick={handleLogOut} ><Link to="/">Logout</Link></li> :  <li ><Link to="/login">Login</Link></li>}
...
{user?.photoURL && <div>
  <img src={user?.photoURL} title={user?.displayName} className="w-14 h-14 rounded-full" />
</div> }
  </div>
</div>
        </div>
